...
local TB_WITH_ALERT_SPRITE = require("ltnt.const").main_frame.button_sprite_alert
local TB_WITHOUT_ALERT_SPRITE = require("ltnt.const").main_frame.button_sprite_bare
